    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.subContainer}>
          <View style={{...styles.infoContainer, flexDirection:'row', marginBottom: 15 }}>
            <Text style={{ fontSize: 25 }}>{title}</Text>
            <Text style={{ fontSize: 25, marginLeft: 105 }}>{price}</Text>
          </View>

          <View style={{...styles.infoContainer, borderTopWidth: 1, borderColor: 'gray'}}>
          ...
          {/* Suggested section */}     
          <View style={{...styles.infoContainer, borderTopWidth: 1, borderColor: 'gray'}}>
            <Text style={{fontSize: 18, marginBottom: 10}}>Suggested Products</Text>
